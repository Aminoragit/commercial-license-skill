...
CommercialLicenseSkill scans local project files. The MVP does not upload source code, contact external APIs, or execute project scripts during scanning.
...
```bash
npx commercial-license-skill@0.3.2 install
```
