...
1. Run a machine-readable scan:
   ...
   ```bash
   npx commercial-license-skill@0.3.2 scan . --format json --output .commercial-license-skill/report.json
   ```
...
```bash
npx commercial-license-skill@0.3.2 scan . --format human
npx commercial-license-skill@0.3.2 scan . --format sarif --output reports/commercial-license-skill.sarif --fail-on high
npx commercial-license-skill@0.3.2 recommend <package-name> --online --json
npx commercial-license-skill@0.3.2 mcp
```
